...
const BienetreScreen = ({navigation}) => {

  const[Bienetre,setBienetre] =useState(null);
  const[loading,setloading] = useState(true);

  useEffect (() => {
    const fetchBienetre= async () => {
      try{
        const list =[];
          await firestore()
        ...
        console.log('Santé bien-être:',Bienetre)
      }catch(e){
        console.log(e);
      }
    } 
