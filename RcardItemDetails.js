    ...
    <View style={styles.container}>
        ...
        <View >
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.galerie}>
               <Image source={{uri: itemData.galerie}}
               style={styles.gale}
               />
               <Image source={{uri: itemData.galerie1}}
               style={styles.gale}
               />
               <Image source={{uri: itemData.galerie2}}
               style={styles.gale}
               />
               <Image source={{uri: itemData.galerie3}}
               style={styles.gale}
               />
               <Image source={{uri: itemData.galerie4}}
              style={styles.gale}
              />
              <Image source={{uri: itemData.galerie5}}
              style={styles.gale}
              />
              <Image source={{uri: itemData.galerie6}}
              style={styles.gale}
              />
          </ScrollView>
        </View>
...
export default RcardItemDetails;
